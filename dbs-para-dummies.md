...
En la versión "deluxe" del sistema (como la que tengo yo), cada contacto está divido en otros tres, de manera que esa radiación puede ser más direccional, permitiendo atacar a una parte mucho más pequeña de tu cerebro. En concreto, cada "sub-contacto" cubre 120 grados , de manera que los tres cubren los 360 grados, alrededor del contacto al que pertenecen.
